...
const HeroComponent = () => {
  return (
    <div className="flex flex-col items-center bg-[var(--color-backgroundColor)] px-2 py-6 md:py-10">
      <div className="text-[var(--color-bluegray)] text-center text-[1.5rem] md:text-[2rem] font-semibold">{heroData.title}</div>
