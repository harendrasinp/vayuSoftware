...
const Header = () => {
  ...
  return (
    <div className="sticky top-0 z-10 bg-gray-950  h-[6rem] flex items-center justify-between text-white overflow-hidden px-4">
      {/* Foreground Content */}
      <div className="relative z-10 flex items-center justify-between w-full">
        {/* Logo & Tagline */}
        <div className="flex justify-center items-center space-x-2 h-fit">
           <img src="/logo/vayupng.png"alt="logo"className="w-[5rem] sm:w-[6rem] h-fit"/>
           <p className="mt-9">Visionary Applications for Your Upliftment</p>
        </div> 
