...
const Contact = () => {
    return (
        <div className="relative">
            <Image src="/contact/background.jpg" alt="about backgorund image" fill className="object-cover" priority />
            <section className="relative py-16 px-6 md:px-20 min-h-[25rem]" id="contact">
